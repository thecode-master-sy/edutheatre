  ...
  return (
    <section className="max-w-7xl mx-auto flex flex-col items-center justify-between lg:flex-row-reverse lg:px-10 bg-white">
      ...
      <div className="text-center lg:text-left lg:w-1/2">
        ...
        <p className="mx-auto text-lg text-gray-600 mt-6">Unlock your potential with tailored tutoring sessions</p>

        <p className="mx-auto text-lg text-gray-600 mt-6">Revolutionize your learning journey with one-on-one guidance</p>

        <p className="mx-auto text-lg text-gray-600 mt-6">Elevate your academic performance with personalized tutoring</p>
        </p>
